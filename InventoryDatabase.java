...
//
    ...
    public void init() {
        try {
            if ( conn == null ) {
               ...
               conn = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=InventoryApp;", "sa", "TestTimer1");
    ...
    public ResultSet getAllActiveItems() throws SQLException // updated function to use prepared statements and replaced the * with actual columns 1-23-18 Sharon
    {
        try {
            ...
            sql = "SELECT InventoryID, ItemName, QTY, ExpireDate, DateEntered FROM Inventory WHERE IsDeleted = 0";
